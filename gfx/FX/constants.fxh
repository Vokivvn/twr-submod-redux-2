...
// ------------------    TERRAIN        -------------------------
// --------------------------------------------------------------
static const float CITY_LIGHTS_TILING 			= 0.04;
...
static const float MUD_STRENGHTEN 				= 0.6;
...
static const float3 ICE_COLOR 					= float3( 0.5f, 0.6f, 1.0f );
static const float 	ICE_NOISE_TILING  			= 0.1f; //0.068f;

static const float WATER_COLOR_LIGHTNESS = 0.54;
static const float WATER_RIPPLE_EFFECT = 0.0225;

static const float COLORMAP_OVERLAY_STRENGTH 	= 0.76f; //0.7f;
...
//static const float3 GB_OUTLINE_COLOR = float3( 0.3f, 0.0f, 0.6f );
...
static const float GB_OPACITY_FAR = 0.88f;  // Transparency when camera is far
